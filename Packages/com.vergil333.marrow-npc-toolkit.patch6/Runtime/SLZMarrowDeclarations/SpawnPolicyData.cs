...
// SLZ.Marrow.Data, SpawnPolicyData). The public Marrow SDK omits the type, so a
...
{
    public class SpawnPolicyData : UnityEngine.ScriptableObject
    {
        public byte groupByCrate;
        public int maxSize;
        public int mode;
        public byte skipDisable;
    }
}
