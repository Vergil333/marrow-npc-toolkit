...
// SLZ.Marrow.Data, EnemyPoseData). The public Marrow SDK omits the type, so a
...
{
    public class EnemyPoseData : UnityEngine.ScriptableObject
    {
        public UnityEngine.Vector3[] posePositions;
        public UnityEngine.Quaternion[] poseRotations;
    }
}
