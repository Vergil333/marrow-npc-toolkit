...
// SLZ.Marrow.Interaction, Tracker). The public Marrow SDK omits the type, so a
...
{
    public class Tracker : UnityEngine.MonoBehaviour
    {
        public SLZ.Marrow.Interaction.MarrowEntity _entity;
        public SLZ.Marrow.Interaction.MarrowBody _body;
        public UnityEngine.Collider _collider;
    }
}
